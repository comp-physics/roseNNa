...
represent them.
The acceptance cases at the end round-trip through ONNX instead, because what
they assert is that a *real* model survives the whole frontend.
"""
import numpy as np
import onnx
import pytest
...
from rosenna.frontend import Graph, Node, Tensor, load_graph
...
# --- acceptance: a model that should NOT be refused -----------------------
