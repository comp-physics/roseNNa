...
def emit_fortran_recipe(plan: Plan) -> str:
    """A Makefile fragment that builds lib<name>.a from the generated module.
    ...
    """
    n = plan.model
    return f"""# Generated by rosenna. Builds lib{n}.a from {n}_model.f90 (and {n}_model.mod).
FC ?= gfortran
...
clean:
\trm -f {n}_model.o {n}_model.mod lib{n}.a
.PHONY: clean
"""
